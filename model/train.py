...
from model.model_arch import LeNet5, CustomMLP
import numpy as np
...
def train(model, trn_loader, device, criterion, optimizer):
    ...
    for i, (images, labels) in enumerate(trn_loader):
        ...
        if (i) % 100 == 0:
            ...
            torch.save(model.critic_1_local.state_dict(), 'model.pth')
...
def main():
    ...
    roottrain='./model/dataset/train/'
    roottest ='./model/dataset/test/'
